...
extern nsresult
NS_GetStreamForMediaStreamURI(nsIURI* aURI, const nsACString& aIsolationKey, mozilla::DOMMediaStream** aStream);

extern nsresult
NS_GetSourceForMediaSourceURI(nsIURI* aURI, const nsACString& isolationKey, mozilla::dom::MediaSource** aSource);
