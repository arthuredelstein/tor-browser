 ...
 */
#define COMMON_GL_MAX_TEXTURE_SIZE                  2048  // Different from the spec, which sets it to 64 on page 162
#define COMMON_GL_MAX_CUBE_MAP_TEXTURE_SIZE         2048  // Different from the spec, which sets it to 16 on page 162
#define COMMON_GL_MAX_VERTEX_ATTRIBS                16    // Page 164
#define COMMON_GL_MAX_FRAGMENT_UNIFORM_VECTORS      224   // Page 164
#define COMMON_GL_MAX_VERTEX_UNIFORM_VECTORS        256   // Page 164
#define COMMON_GL_MAX_VARYING_VECTORS               8     // Page 164
#define COMMON_GL_MAX_TEXTURE_IMAGE_UNITS           8     // Page 164
#define COMMON_GL_MAX_VERTEX_TEXTURE_IMAGE_UNITS    8     // Page 164
#define COMMON_GL_MAX_RENDERBUFFER_SIZE             2048  // Different from the spec, which sets it to 1 on page 164
#define COMMON_GL_MAX_COMBINED_TEXTURE_IMAGE_UNITS  16    // Page 164
...
#define COMMON_GL_ALIASED_LINE_WIDTH_RANGE          5
#define COMMON_GL_ALIASED_POINT_SIZE_RANGE          63
/* This value is used to cap the resolution of the viewport to (MAX x MAX) */
#define COMMON_GL_MAX_VIEWPORT_DIMS                 4096
