...
public:
    ...
    nsAsyncResolveRequest(nsProtocolProxyService *pps, nsIURI *channel,
...
nsresult
nsProtocolProxyService::AsyncResolveInternal(nsIURI *channel, uint32_t flags,
                                             nsIProtocolProxyCallback *callback,
...
// nsIProtocolProxyService
NS_IMETHODIMP
nsProtocolProxyService::AsyncResolve2(nsIURI *channel, uint32_t flags,
                                      nsIProtocolProxyCallback *callback,
                                      nsICancelable **result)
{
